	...
	; Compiler options:
	;
	; -otest_62f08x_tim2_interrupt.cof -mtest_62f08x_tim2_interrupt.map \
	; --summary=default --output=default --codeoffset=00 \
	; test_62f08x_tim2_interrupt.p1 --chip=16F1938 -P --runtime=default \
